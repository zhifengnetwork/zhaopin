<?php
/**
 * ALIPAY API: alipayaop.open.agent.facetoface.sign request
 *
 * @author auto create
...
class AlipayOpenAgentFacetofaceSignRequest
{
	...
	/** 
	 * 所属MCCCode，详情可参考
<a href="https://doc.open.alipayaop.com/doc2/detail.htm?spm=a219a.7629140.0.0.59bgD2&treeId=222&articleId=105364&docType=1#s1
">商家经营类目</a> 中的“经营类目编码”
	 **/
	private $mccCode;
...
">商家经营类目</a> 中的“需要的特殊资质证书”，最小50KB，图片格式必须为：png、bmp、gif、jpg、jpeg
	...
	{
		return "alipayaop.open.agent.facetoface.sign";
	}
