<?php
/**
 * ALIPAY API: alipayaop.open.agent.mini.create request
 *
 * @author auto create
...
应用类目参考文档：https://docs.alipayaop.com/isv/10325
	...
	/** 
	 * 代商户创建的小程序应用名称。名称可以由中文、数字、英文及下划线组成，长度在3-20个字符之间，一个中文字等于2个字符，更多名称规则见：https://docs.alipayaop.com/mini/operation/name
	 **/
	private $appName;
...
商户小程序客服电话和邮箱，可以二选一填写，但不能同时为空
	...
	{
		return "alipayaop.open.agent.mini.create";
	}
