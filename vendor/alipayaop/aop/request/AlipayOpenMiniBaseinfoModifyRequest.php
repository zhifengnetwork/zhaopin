<?php
/**
 * ALIPAY API: alipayaop.open.mini.baseinfo.modify request
 *
 * @author auto create
...
{
	/** 
	 * 11_12;12_13。小程序类目，格式为 第一个一级类目_第一个二级类目;第二个一级类目_第二个二级类目，详细类目可以参考https://docs.alipayaop.com/isv/10325
	 **/
	...
	{
		return "alipayaop.open.mini.baseinfo.modify";
	}
