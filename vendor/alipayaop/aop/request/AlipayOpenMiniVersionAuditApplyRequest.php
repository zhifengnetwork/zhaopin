<?php
/**
 * ALIPAY API: alipayaop.open.mini.version.audit.apply request
 *
 * @author auto create
...
{
	/** 
	 * 小程序类目，格式为 第一个一级类目_第一个二级类目;第二个一级类目_第二个二级类目，详细类目可以参考https://docs.alipayaop.com/isv/10325，如果不填默认采用当前小程序应用类目
	 **/
	...
	/** 
	 * 第五张营业执照照片，不能超过4MB，图片格式只支持jpg，png，部分小程序类目需要提交，参照https://docs.alipayaop.com/isv/10325中是否需要营业执照信息
	 **/
	...
	/** 
	 * 第一张营业执照照片，不能超过4MB，图片格式只支持jpg，png，部分小程序类目需要提交，参照https://docs.alipayaop.com/isv/10325中是否需要营业执照信息
	 **/
	...
	/** 
	 * 第四张营业执照照片，不能超过4MB，图片格式只支持jpg，png，部分小程序类目需要提交，参照https://docs.alipayaop.com/isv/10325中是否需要营业执照信息
	 **/
	...
	/** 
	 * 营业执照名称，部分小程序类目需要提交，参照https://docs.alipayaop.com/isv/10325中是否需要营业执照信息
	 **/
	private $licenseName;
	
	/** 
	 * 营业执照号，部分小程序类目需要提交，参照https://docs.alipayaop.com/isv/10325中是否需要营业执照信息
	 **/
	private $licenseNo;
	
	/** 
	 * 营业执照有效期，格式为yyyy-MM-dd，9999-12-31表示长期，部分小程序类目需要提交，参照https://docs.alipayaop.com/isv/10325中是否需要营业执照信息
	 **/
	...
	/** 
	 * 门头照图片，部分小程序类目需要提交，参照https://docs.alipayaop.com/isv/10325中是否需要营业执照信息
	 **/
	private $outDoorPic;
	...
	/** 
	 * 第二张营业执照照片，不能超过4MB，图片格式只支持jpg，png，部分小程序类目需要提交，参照https://docs.alipayaop.com/isv/10325中是否需要营业执照信息
	 **/
	...
	/** 
	 * 省市区信息，当区域类型为LOCATION时，不能为空，province_code不能为空，当填写city_code时，province_code不能为空，当填写area_code时，province_code和city_code不能为空。只填province_code时，该省全部选择；province_code和city_code都填时，该市全部选择。province_code，city_code和area_code都填时，该县全部选择。具体code可以参考https://docs.alipayaop.com/isv/10327
	 **/
	private $serviceRegionInfo;
	
	/** 
	 * 第三张营业执照照片，不能超过4MB，图片格式只支持jpg，png，部分小程序类目需要提交，参照https://docs.alipayaop.com/isv/10325中是否需要营业执照信息
	 **/
	...
	{
		return "alipayaop.open.mini.version.audit.apply";
	}
